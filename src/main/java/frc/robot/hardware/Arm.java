...
public class Arm {
    ...
    public static final Position ALGAE_L2     = new Position(elevBase+0.6, wristBase+.544, .619);
    ...
    public static final Position ALGAE_PROC   = new Position(elevBase+.475, wristBase+0.549, 0.637);
